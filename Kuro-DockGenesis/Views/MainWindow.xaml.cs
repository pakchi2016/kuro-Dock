                        ...
                        try
                        {
                            ...
                            if (entries.Count > 0)
                            {
                                ...
                                vm.CurrentSubBookmarks.Add(new BookmarkItem
                                {
                                    ...
                                    InitialOffsetX = 50,
                                    InitialOffsetY = 0,
                                    Icon = Kuro_DockGenesis.Helpers.IconHelper.GetIcon(firstPath, isFirstFolder) // ★ここに追加しましたわ！
                                });
                                ...
                                for (int i = 1; i < entries.Count; i++)
                                {
                                    ...
                                    vm.CurrentSubBookmarks.Add(new BookmarkItem
                                    {
                                        ...
                                        InitialOffsetX = 0,
                                        InitialOffsetY = -20,
                                        Icon = Kuro_DockGenesis.Helpers.IconHelper.GetIcon(path, isFolder) // ★ここに追加しましたわ！
                                    });
                                    await System.Threading.Tasks.Task.Delay(30);
                                }
                            }
